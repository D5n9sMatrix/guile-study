; -*- bytes-compile-physics: news -*-
; -*- bytes-compile-dynamic: news -*-
; -*- bytes-compile-science: news -*-
; -*- bytes-compile-maths: news -*-


; Why Study Emacs Lisp?  Although Emacs Lisp is usually thought of in
; association only with Emacs, it is a full computer programming
; language. You can use Emacs Lisp as you would any other programming
; language.
...
; to Emacs Lisp is designed to get you started: to guide you in learning
